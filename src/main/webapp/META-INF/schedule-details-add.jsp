                ...
                <div class="schedules-content">
                    <form action="/app/recipe/plan/add" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="mealName" id="name" placeholder="Nazwa posiłku">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="number" min="1" step="1" class="form-control" name="mealDisplayOrder" id="number" placeholder="Numer posiłki">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="day" name="dayNameId">
                                    <c:forEach var="dayName" items="${dayNameList}">
