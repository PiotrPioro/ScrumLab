        ...
        <div class="m-4 p-3 width-medium ">
            <div class="dashboard-content border-dashed p-3 m-4">
                ...
                <div class="schedules-content">
                    ...
                    <c:if test="${planDetails.id == plan.id}">
                        ...
                        <table class="table">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-1 center">
                                    <a href="/app/plan/details/delete?id=${planDetail.planRecipeId}&planId=${plan.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                </td>
